...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Usa replace(', ', ' ') per rimuovere la virgola predefinita di toLocaleString
        ...
        const embed = new EmbedBuilder()
            ...
            // RIMOSSO: setAuthor() per rimuovere "👤 USER INFORMATION 👥"
            // RIMOSSO: setDescription() per rimuovere la descrizione iniziale e lo stato
            ...
            // RIMOSSO: Footer e Timestamp per abbinare le immagini di riferimento (possono essere riaggiunti se vuoi)
