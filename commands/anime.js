            ...
            try {
                ...
                if (!response.data || !data.data || data.data.length === 0) {
                    return interaction.editReply({
                        content: `<:K3_wrong:1407992234145611867> Anime "${searchQuery}" not found. Try a different or more specific name.`,
                        ephemeral: true
                    });
                }
                ...
                await interaction.editReply({
                    content: `<:K3_wrong:1407992234145611867> An unexpected error occurred while fetching anime data. Please ensure the bot has internet access and the Jikan API is available.`,
                    ephemeral: true
                });
            }
        },
